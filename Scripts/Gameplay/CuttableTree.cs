...
public class CuttableTree : MonoBehaviour, Interactable{
    public IEnumerator Interact(Transform initiator){
        yield return DialogManager.Instance.ShowDialogText("This plant looks like it can be cut.");
        ...
        if(pokemonWithCut != null){
            ...
            yield return DialogManager.Instance.ShowDialogText($"Should {pokemonWithCut.Base.Name} cut this plant?", 
