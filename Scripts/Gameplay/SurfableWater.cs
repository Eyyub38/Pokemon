...
public class SurfableWater : MonoBehaviour, Interactable, IPlayerTriggerable{
    ...
    public IEnumerator Interact(Transform initiator)
    {
        ...
        yield return DialogManager.Instance.ShowDialogText("This water looks like deep blue!");
        ...
        if(pokemonWithSurf != null){
            ...
            yield return DialogManager.Instance.ShowDialogText($"Should {pokemonWithSurf.Base.Name} use surf for you?", 
